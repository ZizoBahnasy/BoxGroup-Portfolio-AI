...
import time
import os
from script_2_extract import extract_companies
from script_3_enrich import enrich_companies
from script_4_clean import clean_companies
...
def run_pipeline():
    ...
    print("1. Initial data: portfolio_1_extracted.json")
    print("2. Enriched data: portfolio_2_enriched.json")
    print("3. Analyzed data: portfolio_3_analyzed.json")
    print("4. Final data with valuations: portfolio_4_valuations.json")
