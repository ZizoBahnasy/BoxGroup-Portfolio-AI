...
def enrich_companies():
    ...
    input_path = os.path.join(data_path, 'portfolio_1_extracted.json')
    output_path = os.path.join(data_path, 'portfolio_2_enriched.json')
        ...
        with open(output_path, 'r') as f:  # Changed from enriched_path to output_path
            ...
            if not content:
                ...
                try:
                    ...
                    print("Warning: Invalid JSON in portfolio_2_enriched.json, starting fresh")
                    existing_data = []
